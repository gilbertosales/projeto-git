...
* Qual é o comportamento atual que você quer mudar ? 
...
* Como você saberia que o problema foi resolvido? 
> descobre a métrica

* Algo já foi tentado antes ? O que aconteceu ?
> revela restrições ocultas e evita repetição de erros

* O que você não quer que aconteça ? 
